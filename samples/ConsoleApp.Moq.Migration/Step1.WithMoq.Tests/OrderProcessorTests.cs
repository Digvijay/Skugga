...
namespace Step1_WithMoq.Tests;

/// <summary>
/// Comprehensive test suite demonstrating ALL major Moq features
/// ⚠️ WARNING: These tests work in JIT mode but will FAIL with Native AOT!
/// </summary>
public class OrderProcessorTests
{
    ...
    public void PropertyMocking_TotalOrders_ReturnsValue()
    {
        ...
        // Act
        var totalOrders = orderServiceMock.Object.TotalOrders;
    ...
    public void CallbackDemonstration_TrackMethodCalls()
    {
        ...
        // Act
        notificationServiceMock.Object.LogActivity("Test activity 1");
        notificationServiceMock.Object.LogActivity("Test activity 2");
    ...
    public void SetupSequence_MultipleReturns_ReturnsInOrder()
    {
        ...
        // Act & Assert
        Assert.Equal(100, inventoryServiceMock.Object.GetAvailableStock(101));
        Assert.Equal(50, inventoryServiceMock.Object.GetAvailableStock(101));
        Assert.Equal(0, inventoryServiceMock.Object.GetAvailableStock(101));
        Assert.Equal(0, inventoryServiceMock.Object.GetAvailableStock(101)); // Repeats last
    }
    ...
    public void ArgumentMatchers_ItIsAny_MatchesAnyValue()
    {
        ...
        // Act & Assert
        Assert.True(paymentServiceMock.Object.ProcessPayment(10.00m, "Visa"));
        Assert.True(paymentServiceMock.Object.ProcessPayment(99.99m, "MasterCard"));
        Assert.True(paymentServiceMock.Object.ProcessPayment(0.01m, "AmEx"));
    }
    ...
    public void ArgumentMatchers_ItIs_MatchesWithPredicate()
    {
        ...
        // Act & Assert
        Assert.True(paymentServiceMock.Object.ProcessPayment(50.00m, "CreditCard"));
        Assert.False(paymentServiceMock.Object.ProcessPayment(1500.00m, "CreditCard")); // Too high
        Assert.False(paymentServiceMock.Object.ProcessPayment(50.00m, "Cash")); // Wrong method
    }
    ...
    public void VerifyWithTimes_AtLeast_ChecksMinimumCalls()
    {
        ...
        // Act
        notificationServiceMock.Object.LogActivity("Activity 1");
        notificationServiceMock.Object.LogActivity("Activity 2");
        notificationServiceMock.Object.LogActivity("Activity 3");
